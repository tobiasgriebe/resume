...
\subject{\bf Bewerbung Director IT}
\opening{Sehr geehrte Damen und Herren,}
auf der Suche einer beruflichen Ver"anderung bin ich mit gro"sem Interesse auf Ihre Stellenausschreibung Director IT am Standort Strausberg gesto"sen. 
...
Als Competence Center Leiter bei der adesso AG habe ich den Aufbau F"uhrung eines Teams von IT Beratern im Themenfeld Digitalisierung und digitale Transformation vorangetrieben. Neben dem Aufbau, der fachlichen und disziplinarischen F"uhrung meines Teams befasse ich mich hier mit Projekten im gesamten Handlungsfeld von Ideation, Identifikation digitalisierbarer Gesch"aftsprozesse, Analyse von Digitalisierungspotenzial existierender und neuer Fachanforderungen, Requirements Engineering, der Koordination, Durchf"uhrung und Begleitung von IT-Projekten in strategischen und operativen Rollen, Erstellung von Handlungsempfehlungen bei Beschaffung, Implementierung und Inbetriebnahme technischer L"osungen sowie mit der Steuerung interner und externer Entwicklungsdienstleister. 
...
Mit Fokus auf die Umsetzung von (IT-)Projekten geh"oren der sichere Umgang mit klassischen und agilen Vorgehensmodellen ebenso zu meinen Kompetenzen wie der Umgang mit State-of-the-Art Werkzeugen zur aktiven und passiven Begleitung von IT-Projekten (z.~B. Jira, Confluence oder MS-TFS). Im Rahmen der von mir verantworteten IT-Projekte konnte ich mir ebenfalls fundierte Kenntnisse in den Bereichen Hardware, Software, Programmiersprachen, Technologien f"ur mobile Softwaresysteme und Cloud-basierte Backend-Systeme aneignen. Analytisches Denkvermögen und die Fähigkeit, mich fachgebietsübergreifend in komplexe Problemstellungen einzudenken verbunden mit einer ganzheitlichen und unternehmerischen Denkweise sowie die Fähigkeit, komplexe Sachverhalte einfach darzustellen, sowie Komplexität zu managen und aktiv zu reduzieren gehören dabei selbstverständlich zu meinen Kompetenzen.

Nun bin ich auf der Suche nach einem neuen Engagement in einem innovativen und dynamischen Umfeld und sehe den Herausforderungen des Director IT mit Spannung entgegen.
...
Ich bin voraussichtlich ab Juni 2019 verf"ugbar. Aufgrund meiner Qualifikation meiner bisherigen Berufsfahrungen liegen meine Gehaltsvorstellungen bei 95.000 Euro/Jahr. 
